...
if __name__ == '__main__':
    ...
    db_travel_watcher = Thread(target=db_travel_daemon, args=(config.get_db_path(),), daemon=True)
    db_travel_watcher.start()
    db_weather_watcher = Thread(target=db_weather_daemon, args=(config.get_db_path(),), daemon=True)
